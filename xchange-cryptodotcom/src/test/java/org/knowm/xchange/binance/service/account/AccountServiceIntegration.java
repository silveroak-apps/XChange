package org.knowm.xchange.cryptodotcom.service.account;
...
import org.knowm.xchange.cryptodotcom.dto.account.AssetDetail;
import org.knowm.xchange.cryptodotcom.dto.account.cryptodotcomDeposit;
import org.knowm.xchange.cryptodotcom.dto.account.TransferHistory;
...
public class AccountServiceIntegration extends cryptodotcomExchangeIntegration {

  static cryptodotcomAccountService accountService;

  @BeforeClass
  public static void beforeClass() throws Exception {
    createExchange();
    accountService = (cryptodotcomAccountService) exchange.getAccountService();
  }
  ...
  public void testAssetDetail() throws Exception {
    ...
    Map<String, AssetDetail> assetDetails =
        ((cryptodotcomAccountService) accountService).getAssetDetails();
  ...
  public void testDepositHistory() throws Exception {
    assumeProduction();
    List<cryptodotcomDeposit> depositHistory = accountService.depositHistory("BTC", null, null);
