...
public class OkexAdapters {
    ...
    public static CandleStickData adaptCandleStickData(List<OkexCandleStick> okexCandleStickList, CurrencyPair currencyPair, long interval) {
        ...
        if (!okexCandleStickList.isEmpty()) {
            ...
            for (OkexCandleStick okexCandleStick : okexCandleStickList) {
                candleStickList.add(new CandleStick.Builder()
                        .timestamp(new Date(okexCandleStick.getTimestamp() + (interval * 1000) - 1))
