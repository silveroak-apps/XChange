...
public class BinanceMarketDataService extends BinanceMarketDataServiceRaw
    ...
    public CandleStickData getCandleStickData(CurrencyPair instrument, CandleStickDataParams params) throws IOException {
        ...
        List<BinanceKline> binanceKlines = klines((CurrencyPair) instrument, periodType, limit, defaultCandleStickParam.getStartDate().getTime(), defaultCandleStickParam.getEndDate().getTime());
        return BinanceAdapters.adaptBinanceCandleStickData(binanceKlines, (CurrencyPair) instrument);
    }
